...
import OwnerData from "./OwnerData.jsx";
  ...
  return (
    <>
      <tr class="bg-gray-800">
        ...
        <td class="p-3 font-bold">{data.area}</td>
        <td class="p-3 font-bold">{data.bathrooms}</td>
        <td class="p-3 font-bold">{data.floors}</td>
        <td class="p-3 font-bold">{data.garage}</td>
        <td class="p-3 font-bold">{data.antiquity}</td>
        <td class="p-3 font-bold">{data.type}</td>
        <td class="p-3">
        ...
        <td class="p-3 ">
          <a href="#" class="text-gray-400 hover:text-gray-100  mx-2">
            <button onClick={(e) => handleEditProperty(e)}>
