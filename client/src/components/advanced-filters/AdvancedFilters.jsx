...
import { filterProperties, resetFilters,filterNormal} from "../../redux/actions/index.js";
...
export default function AdvancedFilters({ setModalOn }) {
  ...
  const {operation,propertyType,city,rooms,bathrooms,idCity,floors,environments, garage,antiquity, area,price} = useSelector(state=>state.filters)
  ...
  useEffect(()=>{
    if (operation||propertyType||city||rooms||bathrooms||idCity||floors||environments|| garage||antiquity|| area||price) {
      ...
      <div className=" h-full ">
        <div>
          ...
          <div className=" h-0  flex flex-col p-2 pb-20">
            <label
              className="sm-text-xl 2xl-text-3xl italic font-semibold text-center text-gray-900 dark:text-white"
              htmlFor="price"
            >
              Precio
            </label>
        ...
        form-control block w-full  px-3 py-1.5 text-base  font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-30  rounded  transition  ease-in-out  m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
          ...
          <div className=" px-2 h-9 ">
            <select
              ref={refOperation}
              className="pb-6 sm:text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              name="operation"
              onChange={stateHandleChange}
          ...
          <div className="px-2">
            <select
              ref={refType}
              className="sm:text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              name="propertyType"
              onChange={stateHandleChange}
