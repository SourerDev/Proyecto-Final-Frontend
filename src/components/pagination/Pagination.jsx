            ...
            <button key={i} className="boton" onClick={() => paginado(number)}>
              <li>
                {currentPage === number ? (
                  <a
                    href="#"
                    className="py-2 px-3 leading-tight text-white-500 bg-sky-600 border rounded-sm"
                  >
                    {number}
                  </a>
                ) : (
                  <a
                    href="#"
                    class="py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-sky-200 hover:red-gray-700 dark:bg-red-800 dark:border-red-700 dark:text-red-400 dark:hover:bg-grared-700 dark:hover:text-white rounded-sm"
                  >
                    {number}
                  </a>
                )}
