...
export function Footer() {
  ...
  return (
    <div className="relative -mx-1 -mb-1 mt-4 flex flex-col items-center bg-[#111111]  py-12 px-6  text-gray-200">
      ...
      <section className="mt-10 flex min-h-[100px] w-full flex-col items-center justify-center border-t-2 border-[#434141]">
