export default function ServiciosExtras() {
  return (
    <div className="my-8 px-4 border-2 bg-blue-50 border-black lg:m-14 rounded-lg ">
      <div className="px-10">
        <h5 className="text-center rounded-lg px-4 bg-gray-800 text-white mt-2">
          Servicios
        </h5>
      </div>
      <div className=" lg:flex m-1 p-1 justify-center items-center inline">
        <div className="text-center p-3 m-4 bg-white text-gray-800 rounded-lg border border-gray-200 ">
