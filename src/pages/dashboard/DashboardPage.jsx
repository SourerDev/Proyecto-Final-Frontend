...
export default function DashboardPage() {
  ...
  return (
    <div>
      <button
        className={`group rounded-t-lg bg-gradient-to-br from-cyan-500 to-blue-500 p-2 text-lg font-medium text-gray-900 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white  ${
          dash === 'Propiedades'
