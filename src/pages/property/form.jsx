...
export default function Form() {
  ...
  return (
    <div className="flex  bg-blue-50 lg:flex-row md:flex-row sm:flex-row flex-col px-2 mt-0">
      <div className="bg-blue-50  ">
        <h4 className="sm-text-xl 2xl-text-3xl italic font-semibold text-center text-gray-900 dark:text-white mb-3">
        ...
        >
          <div className=" flex justify-center ">
            <select
              className="sm:text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              name="modality"
          ...
          <div className="flex flex-row px-2 justify-center">
            <div className="flex flex-col">
              <div className="flex">
                <label
                  htmlFor="adress"
                  className=" px-4 after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 text-base italic font-semibold text-center text-gray-600 dark:text-white"
                >
                  Dirección{" "}
                </label>
              </div>
              <div className="flex flex-row">
                <div id="Direcion" className=" flex flex-col basis-1/2">
                  <input
                    type="text"
                    className=" sm:text-center form-control block  px-3 py-1.5 text-base  font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-30  rounded  transition  ease-in-out  m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
                    placeholder="e.j Av. San Martin"
                    name="adressName"
                    onChange={(e) => handleChange(e)}
                  />
                  {errs.adressName && (
                    <p className=" text-left px-6 mt-2 text-sm text-red-600 dark:text-red-500">
                      {errs.adressName}
                    </p>
                  )}
                </div>
                <div className="px-2 flex flex-col basis-1/2" id="numeroDePiso">
                  <input
                    type="number"
                    className="sm:text-center form-control block w-full  px-3 py-1.5 text-base  font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-30  rounded  transition  ease-in-out  m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
                    name="adressNumber"
                    onChange={(e) => handleChange(e)}
                    placeholder="numero..."
                  />
            ...
            {data.type === "Departamento" && (
              <>
                <div className="px-2">
                  <label
                    className=" after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 text-base italic font-semibold text-center text-gray-600 dark:text-white"
                    htmlFor="dptoNumber"
                  >
                    numero de piso
                  </label>
          ...
          <p className=" flex justify-center text-base italic font-semibold text-center text-gray-600">
          ...
          {!arrFileNames.length ? (
            <p className=" flex justify-center mt-2">Elija dos archivo</p>
          ) : (
          ...
          <p className="text-base italic font-semibold text-center text-gray-600 dark:text-white">
          ...
          <p className=" after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 text-base italic font-semibold text-center text-gray-600 dark:text-white">
            Servicios
          </p>
          {inputServices.map((s) => (
            <FormCheckbox
          ...
          <textarea
            className=" form-control block w-full  px-4 py-1.5 text-base  font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-30  rounded  transition  ease-in-out   focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
            type="text"
            name="description"
            onChange={(e) => handleChange(e)}
          />
          ...
          />
          <br />
          <p className=" after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 text-base italic font-semibold text-center text-gray-600 dark:text-white">{`Por ultimo ingrese ${
            data.modality === "Venta" ? "presouesto" : "precio mensual"
          } de la propiedad (en ARS)`}</p>

          <div className="xl:px-40 px.56 ">
            <input
              className="  form-control block w-full  px-3 py-1.5 text-base  font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-30  rounded  transition  ease-in-out  m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none sm:text-center "
              type="number"
              name="price"
              onChange={(e) => handleChange(e)}
            />
      ...
      <div class="lg:px-3 bg-blue-50 w-full mt-1">
        <div className="bg rounded-lg mb-3 bg-indigo-400">
        ...
        <dl class="mt-4 text-xs font-medium drop-shadow-2xl row-start-2  ">
          <dl className="flex justify-center">
            <dd class="text-black flex items-center ">
              ...
              <span class="text-xl">
                {data.price} <span class="text-black font-normal">usd</span>
              </span>
            </dd>
          </dl>
          <div className="grid  items-center shadow-2xl rounded-lg bg-white col-start-1 col-end-3 row-start-1 sm:mb-3 sm:grid-cols-2">
            ...
            <dd class="text-black m-3 p-1 flex items-center  dark:text-black">
              ...
              <span class="m-3 text-xl p-0">
                {data.garage}{" "}
                <span class="text-black font-normal">(garage)</span>
              </span>
            </dd>
            <dd class="text-black m-3 p-1 flex items-center   dark:text-black">
              <svg
            ...
            <dd class="text-black m-3 p-1 flex items-center  dark:text-black">
              ...
              <span class="m-3 text-xl p-0">
                {data.area} <span class="text-black text-l">.mt2</span>
              </span>
            </dd>
            <dd class="text-black m-3 p-1 flex items-center  dark:text-black">
              <svg
              ...
              <span class="m-3 text-xl p-0">
                {data.rooms} <span class="text-black font-normal">cuartos</span>
              </span>
            </dd>
            <dd class="text-black m-3 p-1 flex items-center dark:text-black">
              <svg
              ...
              <span class="m-3 text-xl p-0">{data.antiquity} </span>
      ...
      {loader && (
        <div
          className="fixed w-full h-screen top-0 z-50 opacity-1"
          onClick={() => {}}
        >
          <Loading />
        </div>
