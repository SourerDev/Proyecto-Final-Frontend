...
export const Views = ({ className, fill, width, height, hover, title }) => {
  return (
    <Svg
      hover={hover}
      fill={fill || 'none'}
...
export const Edit = ({ className, fill, width, height, hover }) => {
  return (
    <Svg
      hover={hover}
      fill={fill || 'none'}
...
export const Question = ({ className, fill, width, height, hover }) => {
  return (
    <Svg
      hover={hover}
      fill={fill || 'none'}
